...
# module references:
# adc_voltage_half, adc_voltage_half, dds_phase_corrector, phase_unwrap, signal_split
...
proc create_hier_cell_DataAcquisition { parentCell nameHier } {
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_m_axis_tdata [get_bd_pins m_axis_tdata] [get_bd_pins axis_red_pitaya_adc_0/m_axis_tdata] [get_bd_pins signal_split_0/S_AXIS_tdata]
  connect_bd_net -net axis_red_pitaya_adc_0_m_axis_tvalid [get_bd_pins m_axis_tvalid] [get_bd_pins axis_red_pitaya_adc_0/m_axis_tvalid] [get_bd_pins signal_split_0/S_AXIS_tvalid]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: adc_voltage_half_0, and set properties
  set block_name adc_voltage_half
  set block_cell_name adc_voltage_half_0
  if { [catch {set adc_voltage_half_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adc_voltage_half_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: adc_voltage_half_1, and set properties
  set block_name adc_voltage_half
  set block_cell_name adc_voltage_half_1
  if { [catch {set adc_voltage_half_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adc_voltage_half_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: dds_phase_corrector_0, and set properties
  set block_name dds_phase_corrector
  set block_cell_name dds_phase_corrector_0
  if { [catch {set dds_phase_corrector_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dds_phase_corrector_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: monitor_freq_gpio, and set properties
  set monitor_freq_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 monitor_freq_gpio ]
  set_property -dict [ list \
  ...
  # Create instance: scaling_gpio, and set properties
  set scaling_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 scaling_gpio ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PS7_M01_AXI [get_bd_intf_pins PS7/M01_AXI] [get_bd_intf_pins scaling_gpio/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PS7/M00_AXI] [get_bd_intf_pins monitor_freq_gpio/S_AXI]

  # Create port connections
  connect_bd_net -net DataAcquisition_m_axis_tdata [get_bd_pins DataAcquisition/m_axis_tdata] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net DataAcquisition_m_axis_tvalid [get_bd_pins DataAcquisition/m_axis_tvalid] [get_bd_pins cordic_0/s_axis_cartesian_tvalid]
  ...
  connect_bd_net -net adc_voltage_half_0_adc_out [get_bd_pins adc_voltage_half_0/adc_out] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net adc_voltage_half_1_adc_out [get_bd_pins adc_voltage_half_1/adc_out] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins dds_phase_corrector_0/gpio2_in] [get_bd_pins monitor_freq_gpio/gpio2_io_i] [get_bd_pins monitor_freq_gpio/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins dds_phase_corrector_0/scale_in] [get_bd_pins scaling_gpio/gpio_io_o]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins DataAcquisition/adc_clk] [get_bd_pins adc_voltage_half_0/clk] [get_bd_pins adc_voltage_half_1/clk] [get_bd_pins axis_constant_0/aclk] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins cordic_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_phase_corrector_0/clk] [get_bd_pins phase_unwrap_0/aclk]
  ...
  connect_bd_net -net cordic_0_m_axis_dout_tdata [get_bd_pins cordic_0/m_axis_dout_tdata] [get_bd_pins phase_unwrap_0/s_axis_tdata]
  connect_bd_net -net cordic_0_m_axis_dout_tvalid [get_bd_pins axis_red_pitaya_dac_0/s_axis_tvalid] [get_bd_pins cordic_0/m_axis_dout_tvalid] [get_bd_pins phase_unwrap_0/s_axis_tvalid]
  ...
  connect_bd_net -net dds_phase_corrector_0_dds_word [get_bd_pins axis_constant_0/cfg_data] [get_bd_pins dds_phase_corrector_0/dds_word]
  connect_bd_net -net phase_unwrap_0_m_axis_tdata [get_bd_pins dds_phase_corrector_0/accum_raw] [get_bd_pins monitor_freq_gpio/gpio_io_i] [get_bd_pins phase_unwrap_0/m_axis_tdata]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PS7/FCLK_CLK0] [get_bd_pins monitor_freq_gpio/s_axi_aclk] [get_bd_pins scaling_gpio/s_axi_aclk]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins PS7/S00_ARESETN] [get_bd_pins monitor_freq_gpio/s_axi_aresetn] [get_bd_pins phase_unwrap_0/aresetn] [get_bd_pins scaling_gpio/s_axi_aresetn]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins cordic_0/s_axis_cartesian_tdata] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins adc_voltage_half_0/adc_in] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins adc_voltage_half_1/adc_in] [get_bd_pins xlslice_1/Dout]

  # Create address segments
  assign_bd_address -offset 0x42000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs monitor_freq_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS7/processing_system7_0/Data] [get_bd_addr_segs scaling_gpio/S_AXI/Reg] -force
